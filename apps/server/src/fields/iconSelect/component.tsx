...
export const IconSelectComponent: React.FC<{ path: string }> = ({ path }) => {
    ...
    <div className="icon-select-field">
      ...
      <div className="icon-select-field-preview-container">
        <div className="icon-select-field-preview">
          {value && (
            <span className="icon-select-field-preview-icon material-symbols-outlined">
              {value}
            </span>
          )}
        </div>
