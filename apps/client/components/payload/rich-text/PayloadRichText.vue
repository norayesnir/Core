<script setup lang="ts">
	...
	interface LexicalParagraphNode
		extends SerializedElementNode<LexicalTextNode> {
		type: "paragraph";
	}
	...
	interface LexicalListNode
		extends SerializedElementNode<LexicalListItemNode> {
		tag: "ol" | "ul";
		type: "list";
	}

	interface LexicalBlockquoteNode
		extends SerializedElementNode<LexicalTextNode> {
		type: "quote";
	}
	...
	const getInternalUrl = (
		doc: LexicalInternalLinkNode["fields"]["doc"]
	) => {
